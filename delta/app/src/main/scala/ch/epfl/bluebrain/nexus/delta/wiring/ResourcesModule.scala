...
import ch.epfl.bluebrain.nexus.delta.sdk.resources.{ResourceValidator, Resources, ResourcesImpl}
...
object ResourcesModule extends ModuleDef {
  ...
  make[ResourceValidator].from((resourceResolution: ResourceResolution[Schema], api: JsonLdApi) =>
    new ResourceValidator(resourceResolution)(api)
  )
