...
import ch.epfl.bluebrain.nexus.delta.plugins.elasticsearch.indexing.ElasticSearchSink.{BulkUpdateException, logger}
...
object ElasticSearchSink {
  ...
  final case class BulkUpdateException(json: JsonObject) extends Exception("Error updating elasticsearch: " + Json.fromJsonObject(json).noSpaces) with NoStackTrace
}
